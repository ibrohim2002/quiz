...
// Faqat tayyor darslar (comingSoon emas)
const availableLessons = computed(() =>
	props.lessons.filter(l => !l.comingSoon),
);

const modeOptions: { value: QuizMode; label: string; meta: string }[] = [
	{
		value: 'mixed',
		label: 'Aralash (Flashcard + Test)',
		meta: 'Tavsiya etiladi',
	},
	{
		value: 'flashcard',
		label: 'Faqat Flashcard',
		meta: "O'zingizni baholaysiz",
	},
	{
		value: 'quiz',
		label: 'Faqat Test (4 variant)',
		meta: 'Avtomatik tekshirish',
	},
];
